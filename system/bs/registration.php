...
if(!$_POST['username']) echo ' <b>Please enter a username.</b><br>';
		...
		mysqli_query($mysqli_link,"select username from mp_users where username ='" . $_POST['username'] . "';");
		...
		// defaults to userlevel 5
			...
			get_results("INSERT INTO `mp_users` ( `username`, `full_name`, `password`, `usergroup`, `email`) VALUES ( '".$_POST['username']."', '".$_POST['fullname']."', '".md5($_POST['pass'])."', '5', '".$_POST['email']."');",1);
